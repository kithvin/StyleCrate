  ...
  return (
    <section className="px-4 lg:px-16 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-8 mt-12 md:mt-18 gap-4 md:gap-x-4">
      ...
      <div className="col-span-1 md:col-span-2 mb-4 md:mb-0 text-center md:text-left">
        ...
        <button className="w-full px-5 py-3 bg-neutral-900 rounded-lg text-white text-center font-medium mt-4 md:mt-8 md:w-auto sm:px-7 transition-all duration-200  md:h-12 border border-neutral-900 flex items-center justify-center mx-auto md:mx-0 cursor-pointer">
          Browse Inspirations
        </button>
      </div>
