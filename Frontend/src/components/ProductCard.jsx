          ...
          <div onClick={(e) => e.stopPropagation()} className="select-none">
            {!isInCart ? (
              <button
                ...
                className="bg-black text-white px-6 py-3 rounded-lg text-sm font-medium transition-colors duration-200 cursor-pointer"
              >
                Buy Now
              </button>
            ) : (
              <div className="text-sm font-medium transition-colors duration-200 cursor-pointer flex items-center justify-center gap-1 bg-gray-200 px-3 py-2 rounded-lg">
                <button
                  onClick={() => removeFromCart(product._id)}
                  className="px-2 text-xl font-medium text-gray-700 hover:text-black"
                >
                  -
                </button>
